...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("<duration> hence|ago",
        Classifier{okData =
                     ClassData{prior = -0.2113090936672069,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.7676619176489945), ("day", -1.7676619176489945),
                                    ("year", -2.327277705584417),
                                    ("<integer> <unit-of-duration>", -0.9409833444645266),
                                    ("month", -2.6149597780361984),
                                    ("fortnight", -2.6149597780361984)],
                               n = 17},
                   koData =
                     ClassData{prior = -1.6582280766035324, unseen = -2.772588722239781,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.6094379124341003), ("year", -1.6094379124341003),
       ...
       ("in|within|after <duration>",
        Classifier{okData =
                     ClassData{prior = -0.23262229526875347,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.5263605246161616),
                                    ("<integer> more <unit-of-duration>", -3.9318256327243257),
                                    ("three-quarters of an hour", -3.0155349008501706),
                                    ("<integer> + '\"", -3.2386784521643803),
                                    ("number.number hours", -3.9318256327243257),
                                    ("second", -3.9318256327243257),
                                    ("half a <time-grain>", -3.0155349008501706),
                                    ("day", -3.5263605246161616), ("year", -3.9318256327243257),
                                    ("<integer> <unit-of-duration>", -1.5339303599259553),
                                    ("quarter of an hour", -3.0155349008501706),
                                    ("hour", -2.4277482359480516),
                                    ("about|exactly <duration>", -3.9318256327243257),
                                    ("half an hour (abbrev).", -3.5263605246161616),
                                    ("<integer> and an half hour", -3.9318256327243257),
                                    ("minute", -1.2576769832977972)],
                               n = 42},
                   koData =
                     ClassData{prior = -1.5723966407537513, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.995732273553991), ("second", -2.995732273553991),
                                    ("day", -2.5902671654458267), ("quarter", -2.995732273553991),
                                    ("year", -1.8971199848858813),
                                    ("<integer> <unit-of-duration>", -1.742969305058623),
                                    ("a <unit-of-duration>", -1.8971199848858813),
       ...
       ("week (grain)",
        Classifier{okData =
                     ClassData{prior = -8.096906253366709e-2,
                               unseen = -4.442651256490317,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 83},
                   koData =
                     ClassData{prior = -2.5538995212749516,
                               unseen = -2.1972245773362196,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 7}}),
       ("<part-of-day> of <time>",
        Classifier{okData =
       ...
       ("a <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -3.295836866004329, unseen = -2.833213344056216,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.803360380906535),
                                    ("hour (grain)", -2.580216829592325),
                                    ("second", -3.4965075614664802),
                                    ("week (grain)", -2.803360380906535),
                                    ("day", -2.803360380906535), ("quarter", -1.6247053845648889),
                                    ("minute (grain)", -2.803360380906535),
                                    ("second (grain) ", -3.4965075614664802),
                                    ("hour", -2.580216829592325),
                                    ("quarter (grain)", -1.6247053845648889),
                                    ("minute", -2.803360380906535),
                                    ("day (grain)", -2.803360380906535)],
                               n = 26}}),
       ...
       ("<duration> after|before|from|past <time>",
        Classifier{okData =
                     ClassData{prior = -0.8803587226480918, unseen = -4.127134385045092,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> <unit-of-duration>hhhmm", -3.417726683613366),
                                    ("a <unit-of-duration>Christmas", -3.417726683613366),
                                    ("minuteminute", -3.417726683613366),
                                    ("dayday", -3.417726683613366),
                                    ("<integer> <unit-of-duration>today", -3.417726683613366),
                                    ("<integer> <unit-of-duration>time-of-day (latent)",
                                     -2.3191143949452564),
                                    ("minutehour", -1.7129785913749407),
                                    ("minutenograin", -3.417726683613366),
                                    ("<integer> <unit-of-duration>Christmas", -3.417726683613366),
                                    ("<integer> <unit-of-duration>Easter Sunday",
                                     -3.417726683613366),
                                    ("secondnograin", -3.417726683613366),
                                    ("<integer> <unit-of-duration><time-of-day> am|pm",
                                     -2.501435951739211),
                                    ("yearday", -2.7245795030534206),
                                    ("<integer> <unit-of-duration>noon|midnight|EOD|end of day",
                                     -3.417726683613366),
                                    ("<integer> <unit-of-duration>now", -3.012261575505202)],
                               n = 17},
                   koData =
                     ClassData{prior = -0.5355182363563622, unseen = -4.330733340286331,
                               likelihoods =
                                 HashMap.fromList
                                   [("a <unit-of-duration>now", -3.624340932976365),
                                    ("quarterhour", -1.3730491343698699),
                                    ("dayhour", -3.624340932976365),
                                    ("<integer> <unit-of-duration>intersect", -3.624340932976365),
                                    ("<integer> <unit-of-duration><day-of-month> (ordinal)",
                                     -3.624340932976365),
                                    ("a <unit-of-duration><time-of-day> am|pm", -2.120263536200091),
                                    ("a <unit-of-duration>time-of-day (latent)",
                                     -2.120263536200091),
                                    ("dayday", -2.9311937524164198),
                                    ("<integer> <unit-of-duration>time-of-day (latent)",
                                     -3.624340932976365),
                                    ("a <unit-of-duration>noon|midnight|EOD|end of day",
                                     -3.2188758248682006),
                                    ("daysecond", -3.624340932976365),
                                    ("a <unit-of-duration>right now", -3.624340932976365),
                                    ("<integer> <unit-of-duration><day-of-month> (ordinal or number) <named-month>",
                                     -3.624340932976365),
                                    ("daynograin", -3.624340932976365)],
                               n = 24}}),

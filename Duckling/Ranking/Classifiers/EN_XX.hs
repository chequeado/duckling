...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("<duration> hence|ago",
        Classifier{okData =
                     ClassData{prior = -0.2719337154836418,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.717651497074333), ("day", -1.717651497074333),
                                    ("year", -2.5649493574615367),
                                    ("<integer> <unit-of-duration>", -0.9555114450274363),
                                    ("month", -2.5649493574615367),
                                    ("fortnight", -2.5649493574615367)],
                               n = 16},
                   koData =
                     ClassData{prior = -1.4350845252893227, unseen = -2.890371757896165,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.7346010553881064), ("year", -1.7346010553881064),
                                    ("<integer> <unit-of-duration>", -1.4469189829363254),
                                    ("a <unit-of-duration>", -1.7346010553881064),
                                    ("month", -2.1400661634962708)],
                               n = 5}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.536116699561526),
                                    ...
                                    ("second", -3.9415818076696905),
                                    ("half a <time-grain>", -3.0252910757955354),
                                    ("day", -3.536116699561526), ("year", -3.9415818076696905),
                                    ("<integer> <unit-of-duration>", -1.54368653487132),
                                    ("quarter of an hour", -3.0252910757955354),
                                    ("hour", -2.4375044108934163),
                                    ("about|exactly <duration>", -3.9415818076696905),
                                    ("half an hour (abbrev).", -3.536116699561526),
                                    ("<integer> and an half hour", -3.9415818076696905),
                                    ("minute", -1.2674331582431617)],
                               n = 42},
                   koData =
                     ClassData{prior = -1.5040773967762742, unseen = -3.784189633918261,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.068052935133617), ("second", -3.068052935133617),
                                    ("day", -2.662587827025453), ("quarter", -3.068052935133617),
                                    ("year", -1.9694406464655074),
                                    ("<integer> <unit-of-duration>", -1.8152899666382492),
                                    ("a <unit-of-duration>", -1.8152899666382492),
                                    ("month", -3.068052935133617), ("minute", -3.068052935133617)],
                               n = 12}}),
       ...
       ("a <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -3.332204510175204, unseen = -2.833213344056216,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.833213344056216),
                                    ...
                                    ("year (grain)", -3.5263605246161616),
                                    ("second", -3.5263605246161616),
                                    ("week (grain)", -2.833213344056216),
                                    ("day", -2.833213344056216), ("quarter", -1.65455834771457),
                                    ("minute (grain)", -2.833213344056216),
                                    ("year", -3.5263605246161616),
                                    ("second (grain) ", -3.5263605246161616),
                                    ("hour", -2.6100697927420065),
                                    ("quarter (grain)", -1.65455834771457),
       ...
       ("<duration> after|before|from|past <time>",
        Classifier{okData =
                     ClassData{prior = -0.9044562742271522, unseen = -4.143134726391533,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> <unit-of-duration>hhhmm", -3.4339872044851463),
                                    ("a <unit-of-duration>Christmas", -3.4339872044851463),
                                    ("minuteminute", -3.4339872044851463),
                                    ("dayday", -3.4339872044851463),
                                    ("<integer> <unit-of-duration>today", -3.4339872044851463),
                                    ("<integer> <unit-of-duration>time-of-day (latent)",
                                     -2.3353749158170367),
                                    ("minutehour", -1.729239112246721),
                                    ("minutenograin", -3.4339872044851463),
                                    ("<integer> <unit-of-duration>Christmas", -3.4339872044851463),
                                    ("<integer> <unit-of-duration>Easter Sunday",
                                     -3.4339872044851463),
                                    ("secondnograin", -3.4339872044851463),
                                    ("<integer> <unit-of-duration><time-of-day> am|pm",
                                     -2.517696472610991),
                                    ("yearday", -2.740840023925201),
                                    ("<integer> <unit-of-duration>noon|midnight|EOD|end of day",
                                     -3.4339872044851463),
                                    ("<integer> <unit-of-duration>now", -3.028522096376982)],
                               n = 17},
                   koData =
                     ClassData{prior = -0.5187937934151675,
                               unseen = -4.3694478524670215,
                               likelihoods =
                                 HashMap.fromList
                                   [("a <unit-of-duration>now", -3.6635616461296463),
                                    ("quarterhour", -1.4122698475231512),
                                    ("dayhour", -3.6635616461296463),
                                    ("<integer> <unit-of-duration>intersect", -3.6635616461296463),
                                    ("<integer> <unit-of-duration><day-of-month> (ordinal)",
                                     -3.6635616461296463),
                                    ("monthnograin", -3.6635616461296463),
                                    ("a <unit-of-duration><time-of-day> am|pm", -2.159484249353372),
                                    ("a <unit-of-duration>time-of-day (latent)",
                                     -2.159484249353372),
                                    ("dayday", -2.9704144655697013),
                                    ("<integer> <unit-of-duration>time-of-day (latent)",
                                     -3.6635616461296463),
                                    ("a <unit-of-duration>noon|midnight|EOD|end of day",
                                     -3.258096538021482),
                                    ("daysecond", -3.6635616461296463),
                                    ("a <unit-of-duration>right now", -3.6635616461296463),
                                    ("<integer> <unit-of-duration><day-of-month> (ordinal or number) <named-month>",
                                     -3.6635616461296463),
                                    ("daynograin", -3.6635616461296463),
                                    ("<integer> <unit-of-duration>now", -3.6635616461296463)],
                               n = 25}}),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.6094379124341003,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Thanksgiving Daya <unit-of-duration>", -1.5040773967762742),

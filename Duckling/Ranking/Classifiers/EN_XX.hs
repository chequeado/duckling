...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5581717443631891, unseen = -6.208590026096629,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 495},
                   koData =
                     ClassData{prior = -0.8492265012936092, unseen = -5.918893854273146,
       ...
       ("from|since|after <time>",
        Classifier{okData =
                     ClassData{prior = -1.717651497074333, unseen = -4.330733340286331,
                               likelihoods =
                                 HashMap.fromList
                   ...
                   koData =
                     ClassData{prior = -0.19782574332991992,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.8066624897703196),
                                    ("week", -4.722953221644475),
                                    ("<day-of-month> (ordinal or number) <named-month>",
                                     -4.722953221644475),
                                    ("today", -4.722953221644475),
                                    ("intersect", -2.9311937524164198),
                                    ("<time> for <duration>", -4.31748811353631),
                                    ("second", -4.722953221644475), ("now", -3.0182051294060495),
                                    ("tomorrow", -4.31748811353631),
                                    ("this|last|next <cycle>", -4.722953221644475),
                                    ("day", -2.371577964480997),
                                    ("time-of-day (latent)", -2.2806061862752705),
                                    ("<time-of-day> am|pm", -4.029806041084529),
                                    ("hh:mm", -4.31748811353631), ("nograin", -3.0182051294060495),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.722953221644475),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)",
                                     -4.722953221644475),
                                    ("Easter Sunday", -4.722953221644475),
                                    ("Christmas", -4.029806041084529), ("hour", -2.120263536200091),
                                    ("month", -4.722953221644475),
                                    ("<datetime> - <datetime> (interval)", -3.1135153092103742),
                                    ("<time-of-day> - <time-of-day> (interval)",
                                     -2.7770430725891617),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -4.31748811353631),
                                    ("minute", -1.7785142424780342),
                                    ("right now", -4.722953221644475),
                                    ("<month> dd-dd (interval)", -4.029806041084529),
                                    ("part of days", -4.722953221644475),
                                    ("dd-dd <month> (interval)", -4.31748811353631)],
                               n = 96}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.8622008809294686), ("quarter", -2.8622008809294686),
                                    ...
                                    ("<integer> <unit-of-duration>", -1.6094379124341003),
                                    ("a <unit-of-duration>", -2.456735772821304),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4874451751219271, unseen = -7.112327444710911,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.418364935936212),
                                    ("Karva Chauthyear (latent)", -6.418364935936212),
                                    ("Maha Shivaratriyear (latent)", -6.418364935936212),
                                    ("Ramadanyear (latent)", -5.1656019674408435),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.032070574816321),
                                    ("Bhai Doojyear (latent)", -6.418364935936212),
                                    ("hourday", -4.4034619153939465),
                                    ("dayhour", -3.5279931780400466),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.032070574816321),
                                    ("Martin Luther King's Dayyear (latent)", -6.012899827828047),
                                    ("Shemini Atzeretyear (latent)", -6.418364935936212),
                                    ("daymonth", -6.418364935936212),
                                    ("monthyear", -4.626605466708156),
                                    ("Yom Ha'atzmautyear (latent)", -6.418364935936212),
                                    ("Orthodox Good Fridayyear (latent)", -6.012899827828047),
                                    ("Vijayadashamiyear (latent)", -6.418364935936212),
                                    ("Thanksgiving Dayyear (latent)", -5.319752647268102),
                                    ("Thai Pongalyear (latent)", -5.725217755376266),
                                    ("Thiru Onamyear (latent)", -5.725217755376266),
                                    ("hhhmmabsorption of , after named day", -6.418364935936212),
                                    ("Krishna Janmashtamiyear (latent)", -6.012899827828047),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.418364935936212),
                                    ("houryear", -5.5020742040620565),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.418364935936212),
                                    ("Christmas<time-of-day> am|pm", -6.418364935936212),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.418364935936212),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.725217755376266),
                                    ("<time-of-day> am|pmintersect", -5.1656019674408435),
                                    ("Earth Houryear (latent)", -6.418364935936212),
                                    ("Ganesh Chaturthiyear (latent)", -6.418364935936212),
                                    ("Octoberyear (latent)", -4.914287539159937),
                                    ("intersect<time-of-day> am|pm", -6.418364935936212),
                                    ("Mattu Pongalyear (latent)", -6.418364935936212),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.418364935936212),
                                    ("Shavuotyear (latent)", -6.418364935936212),
                                    ("Parsi New Yearyear (latent)", -5.5020742040620565),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.418364935936212),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.418364935936212),
                                    ("todayin|within|after <duration>", -6.418364935936212),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.012899827828047),
                                    ("Marchyear (latent)", -6.418364935936212),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.012899827828047),
                                    ("Sukkotyear (latent)", -6.012899827828047),
                                    ("hhhmmintersect", -6.012899827828047),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.418364935936212),
                                    ("Clean Mondayyear (latent)", -6.012899827828047),
                                    ("todayat <time-of-day>", -6.418364935936212),
                                    ("Thursday<time> timezone", -4.020469663137841),
                                    ("tonight<time-of-day> am|pm", -6.418364935936212),
                                    ("time-of-day (latent)tonight", -6.012899827828047),
                                    ("<time-of-day> am|pmon <day>", -4.4034619153939465),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.418364935936212),
                                    ("yyyy-mm-ddhh:mm:ss", -6.012899827828047),
                                    ("dayday", -4.0669896787727335),
                                    ("<time> <part-of-day>at <time-of-day>", -6.012899827828047),
                                    ("mm/ddat <time-of-day>", -5.725217755376266),
                                    ("tonightat <time-of-day>", -5.319752647268102),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.725217755376266),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.418364935936212),
                                    ("today<time-of-day> am|pm", -6.418364935936212),
                                    ("at <time-of-day><time> <part-of-day>", -6.418364935936212),
                                    ("mm/dd<time-of-day> am|pm", -6.418364935936212),
                                    ("hourhour", -3.4479504703665103),
                                    ("Mahavir Jayantiyear (latent)", -6.012899827828047),
                                    ("Navaratriin|during <named-month>|year", -6.418364935936212),
                                    ("Wednesdaythis|last|next <cycle>", -6.418364935936212),
                                    ("Lentyear (latent)", -6.418364935936212),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.54656275903462),
                                    ("Boghiyear (latent)", -6.418364935936212),
                                    ("dayyear", -1.8385125579324098),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.418364935936212),
                                    ("Thursdayfrom|since|after <time>", -6.012899827828047),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.418364935936212),
                                    ("Thursdayat <time-of-day>", -5.725217755376266),
                                    ("Islamic New Yearyear (latent)", -6.012899827828047),
                                    ("Laylat al-Qadryear (latent)", -5.5020742040620565),
                                    ("part of days<time-of-day> am|pm", -6.418364935936212),
                                    ("Shrove Tuesdayyear (latent)", -6.418364935936212),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.725217755376266),
                                    ("hourminute", -6.012899827828047),
                                    ("<time-of-day> am|pmtomorrow", -5.5020742040620565),
                                    ("Yom Kippuryear (latent)", -6.418364935936212),
                                    ("<part-of-day> of <time>year (latent)", -6.418364935936212),
                                    ("minutehour", -5.1656019674408435),
                                    ("Kaanum Pongalyear (latent)", -6.012899827828047),
                                    ("Maha Saptamiyear (latent)", -6.418364935936212),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.725217755376266),
                                    ("time-of-day (latent)tomorrow", -5.5020742040620565),
                                    ("part of daysat <time-of-day>", -4.808927023502111),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.4034619153939465),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.418364935936212),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.1656019674408435),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.1656019674408435),
                                    ("time-of-day (latent)this <part-of-day>", -6.418364935936212),
                                    ("Pentecostyear (latent)", -6.418364935936212),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.1656019674408435),
                                    ("Eid al-Fitryear (latent)", -5.032070574816321),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.418364935936212),
                                    ("Chhathin|during <named-month>|year", -6.418364935936212),
                                    ("Diwaliin|during <named-month>|year", -6.418364935936212),
                                    ("this <part-of-day><time-of-day> am|pm", -6.418364935936212),
                                    ("Vaisakhiin|during <named-month>|year", -6.418364935936212),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.1656019674408435),
                                    ("Raksha Bandhanyear (latent)", -6.418364935936212),
                                    ("daysecond", -6.012899827828047),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.012899827828047),
                                    ("Ratha-Yatrayear (latent)", -6.418364935936212),
                                    ("Ashurayear (latent)", -6.418364935936212),
                                    ("Tuesdayin|during <named-month>|year", -6.418364935936212),
                                    ("Chinese New Yearyear (latent)", -6.418364935936212),
                                    ("tomorrowintersect", -6.418364935936212),
                                    ("Lag BaOmeryear (latent)", -6.418364935936212),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.418364935936212),
                                    ("Eid al-Adhayear (latent)", -4.278298772439941),
                                    ("Palm Sundayyear (latent)", -6.418364935936212),
                                    ("Christmasat <time-of-day>", -6.418364935936212),
                                    ("Passoveryear (latent)", -6.418364935936212),
                                    ("Lazarus Saturdayyear (latent)", -6.418364935936212),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.012899827828047),
                                    ("hhhmmon <day>", -5.5020742040620565),
                                    ("Yom HaShoahyear (latent)", -6.012899827828047),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.012899827828047),
                                    ("Septemberyear (latent)", -6.012899827828047),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.914287539159937),
                                    ("Halloweenyear (latent)", -6.418364935936212),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.418364935936212),
                                    ("at <time-of-day>intersect", -5.5020742040620565),
                                    ("Rosh Hashanahyear (latent)", -5.725217755376266),
                                    ("Dhanterasyear (latent)", -6.418364935936212),
                                    ("Tu BiShvatyear (latent)", -6.418364935936212),
                                    ("Holiyear (latent)", -5.725217755376266),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.418364935936212),
                                    ("Holika Dahanyear (latent)", -5.725217755376266),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.012899827828047),
                                    ("dayminute", -3.0339746725904373),
                                    ("Mawlidyear (latent)", -6.418364935936212),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.012899827828047),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.418364935936212),
                                    ("Jumu'atul-Widayear (latent)", -5.5020742040620565),
                                    ("minuteday", -2.6688608600058403),
                                    ("absorption of , after named dayintersect",
                                     -5.725217755376266),
                                    ("Orthodox Easter Sundayyear (latent)", -6.418364935936212),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.418364935936212),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.418364935936212),
                                    ("intersecthhhmm", -6.012899827828047),
                                    ("Boss's Dayyear (latent)", -6.012899827828047),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.418364935936212),
                                    ("Global Youth Service Dayyear (latent)", -6.418364935936212),
                                    ("Dhanterasin|during <named-month>|year", -6.418364935936212),
                                    ("tonight<time-of-day> o'clock", -6.418364935936212),
                                    ("Tisha B'Avyear (latent)", -6.418364935936212),
                                    ("Isra and Mi'rajyear (latent)", -5.5020742040620565),
                                    ("at <time-of-day>on <day>", -4.808927023502111),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.012899827828047),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.725217755376266),
                                    ("Christmasyear (latent)", -6.012899827828047),
                                    ("Saturdayintersect", -6.418364935936212),
                                    ("Naraka Chaturdashiyear (latent)", -6.012899827828047),
                                    ("Thai Pongalin|during <named-month>|year", -6.418364935936212),
                                    ("dayweek", -6.418364935936212),
                                    ("Easter Sundayyear (latent)", -5.725217755376266),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.012899827828047),
                                    ("weekyear", -5.319752647268102),
                                    ("King's Dayyear (latent)", -4.914287539159937),
                                    ("hh:mmin|during the <part-of-day>", -5.5020742040620565),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.012899827828047),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.725217755376266),
                                    ("Hanukkahyear (latent)", -5.725217755376266),
                                    ("Rama Navamiyear (latent)", -6.418364935936212),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.725217755376266),
                                    ("Great Lentyear (latent)", -6.418364935936212),
                                    ("tomorrowat <time-of-day>", -5.725217755376266),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.418364935936212),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.012899827828047),
                                    ("Ugadiyear (latent)", -5.032070574816321),
                                    ("Vaisakhiyear (latent)", -5.725217755376266),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.725217755376266),
                                    ("last <cycle> of <time>year (latent)", -5.725217755376266),
                                    ("at <time-of-day>tomorrow", -6.012899827828047),
                                    ("tomorrow<time-of-day> am|pm", -6.418364935936212),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.418364935936212),
                                    ("Diwaliyear (latent)", -6.418364935936212),
                                    ("between <time> and <time>on <day>", -6.012899827828047),
                                    ("Black Fridayyear (latent)", -6.012899827828047),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.418364935936212),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.418364935936212),
                                    ("Chhathyear (latent)", -6.012899827828047),
                                    ("Vasant Panchamiyear (latent)", -6.418364935936212),
                                    ("Rabindra Jayantiyear (latent)", -5.1656019674408435),
                                    ("this <part-of-day>at <time-of-day>", -5.1656019674408435),
                                    ("St Patrick's Dayyear (latent)", -6.418364935936212),
                                    ("Thursday<time> (timezone)", -6.418364935936212),
                                    ("Pargat Diwasyear (latent)", -5.1656019674408435),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.725217755376266),
                                    ("Simchat Torahyear (latent)", -6.418364935936212),
                                    ("minuteyear", -6.418364935936212)],
                               n = 476},
                   koData =
                     ClassData{prior = -0.9524194559626605, unseen = -6.771935555839602,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.5735648465727605),
                                    ("hourday", -3.4749525579046505),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.077642243349034),
                                    ("dayhour", -3.3368022194238334),
                                    ("<time> timezoneyear (latent)", -5.384495062789089),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.161351511474879),
                                    ("Tuesdayfrom|since|after <time>", -5.384495062789089),
                                    ("daymonth", -3.826350444742539),
                                    ("hourquarter", -5.161351511474879),
                                    ...
                                    ("from <datetime> - <datetime> (interval)July",
                                     -6.077642243349034),
                                    ("houryear", -4.285882774120979),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.077642243349034),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.384495062789089),
                                    ("hournograin", -4.824879274853666),
                                    ("<time-of-day> am|pmintersect", -4.824879274853666),
                                    ("Octoberyear (latent)", -5.67217713524087),
                                    ("Good Fridayyear (latent)", -5.67217713524087),
                                    ...
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.077642243349034),
                                    ("time-of-day (latent)intersect", -5.384495062789089),
                                    ...
                                    ("from|since|after <time>July", -6.077642243349034),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.161351511474879),
                                    ("Clean Mondayyear (latent)", -6.077642243349034),
                                    ("hourmonth", -3.9982007016691985),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.67217713524087),
                                    ("Thursdayhh:mm", -5.161351511474879),
                                    ("minutemonth", -3.9375760798527635),
                                    ...
                                    ("hourweek", -5.161351511474879),
                                    ("Christmasat <time-of-day>", -6.077642243349034),
                                    ("from|since|after <time>year (latent)", -4.979029954680924),
                                    ...
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.67217713524087),
                                    ("dayminute", -3.2154413624195657),
                                    ("yyyy-mm-ddhh:mm", -5.67217713524087),
                                    ("intersectfrom|since|after <time>", -5.67217713524087),
                                    ("intersectSeptember", -4.2058400664474425),
                                    ("minuteday", -2.9206418221989208),
                                    ("absorption of , after named dayintersect",
                                     -6.077642243349034),
                                    ...
                                    ("from|since|after <time>on <day>", -5.161351511474879),
                                    ("dayweek", -6.077642243349034),
                                    ("Easter Sundayyear (latent)", -5.67217713524087),
                                    ("Thursday<time-of-day> am|pm", -4.824879274853666),
                                    ("weekyear", -5.67217713524087),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.384495062789089),
                                    ("Sundayfrom|since|after <time>", -6.077642243349034),
                                    ...
                                    ("daynograin", -5.67217713524087),
                                    ("Fridayin|during <named-month>|year", -6.077642243349034),
                                    ...
                                    ("Fridayyear (latent)", -5.161351511474879),
                                    ("time-of-day (latent)April", -6.077642243349034),
                                    ("minuteyear", -3.8804176660128147)],
                               n = 299}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("quarterhour", -1.2750687260096663),
                                    ...
                                    ("monthnograin", -3.5263605246161616),
                                    ...
                                    ("<integer> <unit-of-duration><day-of-month> (ordinal or number) <named-month>",
                                     -3.5263605246161616),
                                    ("<integer> <unit-of-duration>now", -3.5263605246161616)],
                               n = 21}}),

...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5567197534757705, unseen = -6.206575926724928,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 494},
                   koData =
                     ClassData{prior = -0.8511723324947622, unseen = -5.91350300563827,
       ...
       ("ordinals (first..twentieth,thirtieth,...)",
        Classifier{okData =
                     ClassData{prior = -0.3417492937220567, unseen = -3.367295829986474,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 27},
                   koData =
                     ClassData{prior = -1.2396908869280152,
                               unseen = -2.5649493574615367,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 11}}),
       ("Mawlid",
        Classifier{okData =
